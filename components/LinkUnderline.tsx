...
> = (props) => {
  return (
    <TextLink
      className="bg-gradient-to-br from-slate-6 to-slate-6 bg-0/6 bg-left-bottom bg-no-repeat transition-background-size duration-300 ease-bounce hocus:bg-100/6"
      {...props}
    />
  )
}
