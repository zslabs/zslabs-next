          ...
          <Dialog.Portal forceMount>
            <Dialog.Overlay asChild forceMount>
              <motion.div
                ...
                animate="visible"
                exit="hidden"
                className="fixed inset-0 bg-blackA-11 z-50 pr-4 backdrop-blur-sm"
              >
                <Dialog.Content
                ...
                >
                  <motion.div
                    ...
                    animate="visible"
                    exit="hidden"
                    className="overflow-auto bg-slate-1 rounded-tr-2xl shadow-lg z-20 relative top-0 left-0 h-full w-full md:max-w-xs pt-16 px-8 pb-8"
